"""Security primitives for Mondo release downloads."""
...
class DownloadPolicy:
    """Exact destinations and hard limits for one Mondo source."""
...
def open_validated_stream(
    ...
    *,
    ...
    """Open a streamed GET after validating every redirect before I/O."""
    try:
